...
Lstm basic::lstm_compiled(size_t a_units, size_t a_max_timesteps, param_vector& a_param_vec) {
...
Stacked_recurrent basic::lstm_mdim(size_t a_x_units, size_t a_h_units, size_t a_y_units, param_vector& a_param_vec) {
...
Stacked_recurrent basic::lstm_mdim_compiled(size_t a_x_units, size_t a_h_units, size_t a_y_units, size_t a_max_timesteps, param_vector& a_param_vec) {

	Stacked_recurrent result = lstm_mdim(a_x_units, a_h_units, a_y_units, a_param_vec);
