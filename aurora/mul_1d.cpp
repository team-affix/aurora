...
void mul_1d::compile()
{
	...
	{
		m_x[0][i].group_link(m_layer->m_x[i][0]);
		m_x_grad[0][i].group_link(m_layer->m_x_grad[i][0]);
		m_x[1][i].group_link(m_layer->m_x[i][1]);
		m_x_grad[1][i].group_link(m_layer->m_x_grad[i][1]);
	}

	m_y.group_link(m_layer->m_y);
	m_y_grad.group_link(m_layer->m_y_grad);
