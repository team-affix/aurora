...
void ntm_writer::compile() {
	...
	m_internal_head->m_internal_rh->m_key.group_join(m_internal_addresser->m_key);
	m_internal_head->m_internal_rh->m_key_grad.group_join(m_internal_addresser->m_key_grad);
	m_internal_head->m_internal_rh->m_beta.group_join(m_internal_addresser->m_beta);
	m_internal_head->m_internal_rh->m_beta_grad.group_join(m_internal_addresser->m_beta_grad);
	m_internal_head->m_internal_rh->m_g.group_join(m_internal_addresser->m_g);
	m_internal_head->m_internal_rh->m_g_grad.group_join(m_internal_addresser->m_g_grad);
	m_internal_head->m_internal_rh->m_s.group_join(m_internal_addresser->m_s);
	m_internal_head->m_internal_rh->m_s_grad.group_join(m_internal_addresser->m_s_grad);
	m_internal_head->m_internal_rh->m_gamma.group_join(m_internal_addresser->m_gamma);
	m_internal_head->m_internal_rh->m_gamma_grad.group_join(m_internal_addresser->m_gamma_grad);
